...
map <A-r> :python debugger_resize()<cr>
map <A-i> :python debugger_command('step_into')<cr>
map <A-o> :python debugger_command('step_over')<cr>
map <A-s> :call <SID>startDebugging()<cr>
map <A-q> :call <SID>stopDebugging()<cr>
map <A-c> :python debugger_context()<cr>
map <A-p> :python debugger_property()<cr>
map <A-t> :python debugger_watch_input("context_get")<cr>A<cr>
map <A-e> :python debugger_watch_input("property_get", '<cword>')<cr>A<cr>

...
" F7 - NERDTree
nmap <silent> <F7> :NERDTreeToggle [path_to_projects]/[project]<CR>
vmap <silent> <F7> <esc>:NERDTreeToggle [path_to_projects]/[project]<CR>i
imap <silent> <F7> <esc>:NERDTreeToggle [path_to_projects]/[project]<CR>i
...
function! UPDATE_TAGS()
  let _f_ = expand("%:p")
  let _cmd_ = '"ctags -a -f [path_to_tags]/[project] --PHPkinds=+cf --totals --tag-relative " ' . '"' . _f_ . '"'
